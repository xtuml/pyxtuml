...
CREATE ROP REF_ID R1658 FROM 1C D_TSS (Term_ID) TO 1 D_TERM (Term_ID);
CREATE ROP REF_ID R1659 FROM MC D_SIS (Seq_ID) TO 1 D_TSS (Seq_ID);
CREATE ROP REF_ID R1660 FROM 1C D_SIS (Svc_ID) TO 1 D_TSVC (Svc_ID);
CREATE ROP REF_ID R1661 FROM 1C D_SIS (Previous_Svc_ID) PHRASE 'succeeds' TO 1C D_SIS (Svc_ID) PHRASE 'precedes';
...
CREATE UNIQUE INDEX I1 ON D_TSS (Seq_ID);
