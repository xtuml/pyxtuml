...
CREATE UNIQUE INDEX I1 ON CL_IPINS (ImportedProvision_Id, Satisfaction_Id);
CREATE UNIQUE INDEX I1 ON CL_IR (Id);
CREATE UNIQUE INDEX I1 ON CL_POR (Id);
CREATE UNIQUE INDEX I1 ON CNST_CSP (Constant_Spec_ID);
CREATE UNIQUE INDEX I1 ON CNST_LFSC (Const_ID);
CREATE UNIQUE INDEX I1 ON CNST_LSC (Const_ID);
CREATE UNIQUE INDEX I1 ON CNST_SYC (Const_ID);
...
CREATE UNIQUE INDEX I1 ON D_TSPARM (TSParm_ID);
CREATE UNIQUE INDEX I1 ON D_TSVC (Svc_ID);
CREATE UNIQUE INDEX I1 ON EP_PKG (Package_ID);
CREATE UNIQUE INDEX I1 ON EP_PKGREF (Referring_Package_ID);
...
CREATE UNIQUE INDEX I1 ON I_BSF (Block_ID, Stack_Frame_ID);
...
CREATE UNIQUE INDEX I1 ON I_MON (Inst_ID, Execution_Engine_ID);
...
CREATE UNIQUE INDEX I1 ON O_DEF (Tfr_ID, Rel_ID);
...
CREATE UNIQUE INDEX I1 ON O_REF (ROid_ID, RAttr_ID, OIR_ID, ROIR_ID, RObj_ID, Obj_ID, Rel_ID);
CREATE UNIQUE INDEX I1 ON O_RTIDA (Attr_ID, OIR_ID, Oid_ID, Obj_ID, Rel_ID);
...
CREATE UNIQUE INDEX I1 ON PA_SIC (Component_Id, Satisfaction_Id);
...
CREATE UNIQUE INDEX I1 ON RV_VIA (RuntimeValue_ID, ContainedRuntimeValue_ID);
CREATE UNIQUE INDEX I1 ON RV_VIS (RuntimeValue_ID, ContainedRuntimeValue_ID);
CREATE UNIQUE INDEX I1 ON R_AONE (OIR_ID, Obj_ID, Rel_ID);
CREATE UNIQUE INDEX I1 ON R_AOTH (OIR_ID, Obj_ID, Rel_ID);
CREATE UNIQUE INDEX I1 ON R_ASSOC (Rel_ID);
CREATE UNIQUE INDEX I1 ON R_ASSR (OIR_ID, Obj_ID, Rel_ID);
CREATE UNIQUE INDEX I1 ON R_COMP (Rel_ID);
CREATE UNIQUE INDEX I1 ON R_CONE (OIR_ID, Obj_ID, Rel_ID);
CREATE UNIQUE INDEX I1 ON R_COTH (OIR_ID, Obj_ID, Rel_ID);
CREATE UNIQUE INDEX I1 ON R_FORM (OIR_ID, Obj_ID, Rel_ID);
CREATE UNIQUE INDEX I1 ON R_OIR (OIR_ID, Obj_ID, Rel_ID);
CREATE UNIQUE INDEX I1 ON R_PART (OIR_ID, Obj_ID, Rel_ID);
CREATE UNIQUE INDEX I1 ON R_REL (Rel_ID);
CREATE UNIQUE INDEX I1 ON R_RGO (OIR_ID, Obj_ID, Rel_ID);
CREATE UNIQUE INDEX I1 ON R_RTO (OIR_ID, Obj_ID, Rel_ID);
CREATE UNIQUE INDEX I1 ON R_SIMP (Rel_ID);
CREATE UNIQUE INDEX I1 ON R_SUB (OIR_ID, Obj_ID, Rel_ID);
CREATE UNIQUE INDEX I1 ON R_SUBSUP (Rel_ID);
CREATE UNIQUE INDEX I1 ON R_SUPER (OIR_ID, Obj_ID, Rel_ID);
CREATE UNIQUE INDEX I1 ON SEN_ALE (Id);
CREATE UNIQUE INDEX I1 ON SEN_DCE (Id);
CREATE UNIQUE INDEX I1 ON SEN_DE (Id);
CREATE UNIQUE INDEX I1 ON SEN_E (Id);
CREATE UNIQUE INDEX I1 ON SEN_RE (Id);
CREATE UNIQUE INDEX I1 ON SM_ACT (SM_ID, Act_ID);
CREATE UNIQUE INDEX I1 ON SM_AH (Act_ID, SM_ID);
CREATE UNIQUE INDEX I1 ON SM_ASM (SM_ID);
CREATE UNIQUE INDEX I1 ON SM_CH (SMevt_ID, SM_ID, SMstt_ID);
CREATE UNIQUE INDEX I1 ON SM_CRTXN (SM_ID, Trans_ID);
CREATE UNIQUE INDEX I1 ON SM_EIGN (SMevt_ID, SM_ID, SMstt_ID);
...
CREATE UNIQUE INDEX I1 ON SM_MEAH (Trans_ID, SM_ID);
...
CREATE UNIQUE INDEX I1 ON SM_NSTXN (SMevt_ID, SMstt_ID, SM_ID);
CREATE UNIQUE INDEX I1 ON SM_PEVT (SM_ID, SMevt_ID);
CREATE UNIQUE INDEX I1 ON SM_SDI (SMedi_ID, SM_ID);
CREATE UNIQUE INDEX I1 ON SM_SEME (SMevt_ID, SM_ID, SMstt_ID);
CREATE UNIQUE INDEX I1 ON SM_SEVT (SMevt_ID, SM_ID);
CREATE UNIQUE INDEX I1 ON SM_SGEVT (SMevt_ID, SM_ID);
CREATE UNIQUE INDEX I1 ON SM_SM (SM_ID);
CREATE UNIQUE INDEX I1 ON SM_STATE (SM_ID, SMstt_ID);
CREATE UNIQUE INDEX I1 ON SM_SUPDT (SMspd_ID, SM_ID);
CREATE UNIQUE INDEX I1 ON SM_TAH (Act_ID, SM_ID);
CREATE UNIQUE INDEX I1 ON SM_TXN (Trans_ID, SM_ID);
...
CREATE UNIQUE INDEX I1 ON SP_ALS (Id);
CREATE UNIQUE INDEX I1 ON SP_DS (Id);
CREATE UNIQUE INDEX I1 ON SP_NS (Id);
CREATE UNIQUE INDEX I1 ON SP_SE (Id);
CREATE UNIQUE INDEX I1 ON SP_SP (Id);
CREATE UNIQUE INDEX I1 ON SQU_A (Id);
CREATE UNIQUE INDEX I1 ON SQU_D (Id);
CREATE UNIQUE INDEX I1 ON SQU_DE (Id);
CREATE UNIQUE INDEX I1 ON SQU_Q (Id);
CREATE UNIQUE INDEX I1 ON SQU_R (Id);
...
CREATE UNIQUE INDEX I1 ON SR_CM (Id);
CREATE UNIQUE INDEX I1 ON SR_CMR (Id);
CREATE UNIQUE INDEX I1 ON SR_M (Id);
...
CREATE UNIQUE INDEX I1 ON S_EEEDT (EEedi_ID, EEevt_ID, EE_ID);
...
CREATE UNIQUE INDEX I1 ON S_EXP (Exception_ID);
CREATE UNIQUE INDEX I1 ON S_IRDT (DT_ID);
CREATE UNIQUE INDEX I1 ON S_MBR (Member_ID, Parent_DT_DT_ID);
CREATE UNIQUE INDEX I1 ON S_RANGE (DT_ID);
...
CREATE UNIQUE INDEX I1 ON V_EPR (Value_ID, SM_ID, SMedi_ID, PP_Id);
...
CREATE UNIQUE INDEX I2 ON I_EQE (Execution_Engine_ID, Event_ID);
CREATE UNIQUE INDEX I2 ON I_RCH (Execution_Engine_ID, other_Execution_Engine_ID, Satisfaction_Id);
CREATE UNIQUE INDEX I2 ON I_SQE (Execution_Engine_ID, Event_ID);
CREATE UNIQUE INDEX I2 ON O_REF (ARef_ID);
CREATE UNIQUE INDEX I2 ON R_RTO (Oid_ID, OIR_ID, Obj_ID, Rel_ID);
CREATE UNIQUE INDEX I2 ON SM_EVT (SM_ID, SMevt_ID);
CREATE UNIQUE INDEX I2 ON SM_MEAH (SM_ID, Act_ID);
CREATE UNIQUE INDEX I2 ON SM_MOAH (Act_ID, SM_ID);
